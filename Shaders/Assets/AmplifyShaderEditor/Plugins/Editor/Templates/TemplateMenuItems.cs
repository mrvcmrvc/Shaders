...
namespace AmplifyShaderEditor
{
	public class TemplateMenuItems
	{
		...
		[MenuItem( "Assets/Create/Amplify Shader/Templates/Legacy/CustomMultiPassPostProcess", false, 85 )]
		public static void ApplyTemplateTemplatesLegacyCustomMultiPassPostProcess()
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "958921d600d7d45bf8d5d0d9cb5b541d" );
		}
	}
}
