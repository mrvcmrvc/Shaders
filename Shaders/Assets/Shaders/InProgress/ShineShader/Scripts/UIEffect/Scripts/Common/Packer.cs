...
public static class Packer
{
    ...
    public static float ToFloat(float x, float y)
    {
        ...
        float result = (Mathf.FloorToInt(y * PRECISION) << 12)
                       + Mathf.FloorToInt(x * PRECISION);
        
        Debug.Log("y * PRECISION: " + Mathf.FloorToInt(y * PRECISION));
        Debug.Log("y * PRECISION << 12: " + (Mathf.FloorToInt(y * PRECISION) << 12));

        Debug.Log("x * PRECISION: " + Mathf.FloorToInt(x * PRECISION));
