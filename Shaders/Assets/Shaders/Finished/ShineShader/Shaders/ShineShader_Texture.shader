	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float3 temp_output_9_0_g6 = _ShineColor.rgb;
				float3 hsvTorgb3_g6 = RGBToHSV( temp_output_9_0_g6 );
				float3 hsvTorgb6_g6 = HSVToRGB( float3(hsvTorgb3_g6.x,hsvTorgb3_g6.y,( hsvTorgb3_g6.z + _Glow )) );
				float4 appendResult218 = (float4(( temp_output_9_0_g6 * hsvTorgb6_g6 ) , _ShineColor.a));
				float temp_output_247_0 = ( 1.0 / abs( _XSpeed ) );
				float temp_output_15_0_g5 = _Delay;
				float temp_output_6_0_g5 = ( _Time.y % ( temp_output_247_0 + temp_output_15_0_g5 ) );
				float2 break283 = _ShineTexture_ST.xy;
				...
				float2 appendResult262 = (float2(( sign( _XSpeed ) * (-1.0 + (( ( temp_output_6_0_g5 >= temp_output_15_0_g5 ? temp_output_6_0_g5 : 0.0 ) - temp_output_15_0_g5 ) - 0.0) * (break283.x - -1.0) / (temp_output_247_0 - 0.0)) ) , ( (-1.0 + (( ( temp_output_6_0_g4 >= temp_output_15_0_g4 ? temp_output_6_0_g4 : 0.0 ) - temp_output_15_0_g4 ) - 0.0) * (break283.y - -1.0) / (temp_output_248_0 - 0.0)) * sign( _YSpeed ) )));
...
/*ASEBEGIN
Version=18800
116;-1305;1831;1211;1827.195;-1579.228;1.219972;True;False
...
Node;AmplifyShaderEditor.TextureTransformNode;282;-1262.618,1984.485;Inherit;False;91;False;1;0;SAMPLER2D;;False;2;FLOAT2;0;FLOAT2;1
...
Node;AmplifyShaderEditor.BreakToComponentsNode;283;-1047.618,1989.485;Inherit;False;FLOAT2;1;0;FLOAT2;0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.WireNode;284;-659.6177,2002.485;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;261;-948.2505,1877.429;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;285;-659.6177,2002.485;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;280;-536.3389,1455.016;Inherit;False;DelayedRemapper;-1;;5;9a813013bc16c4a8d875950108b5fb21;0;7;15;FLOAT;0;False;4;FLOAT;0;False;3;FLOAT;0;False;11;FLOAT;0;False;12;FLOAT;0;False;13;FLOAT;-1;False;14;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;216;1321.407,1161.45;Inherit;False;AddBrightnessToColor;-1;;6;74d7e655a5e1c4e75ac14bf3ca74e7c2;0;2;9;FLOAT3;0,0,0;False;11;FLOAT;0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=65615F9D109959FEAFD49965B2FDB5A9A729B0F0