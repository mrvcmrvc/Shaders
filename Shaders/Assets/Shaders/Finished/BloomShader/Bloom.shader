	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				float4 tex2DNode114 = tex2D( _OriginalTexture, uv_OriginalTexture );
		...
		{ 
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				float2 uv_MainTex = i.uv.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 appendResult27 = (float4(_MainTex_TexelSize.x , _MainTex_TexelSize.y , _MainTex_TexelSize.x , _MainTex_TexelSize.y));
				float4 break9 = ( appendResult27 * float4( 0,0,0,0 ) );
				float2 appendResult13 = (float2(break9.x , break9.y));
				float4 tex2DNode20 = tex2D( _MainTex, ( uv_MainTex + appendResult13 ) );
				float3 appendResult28 = (float3(tex2DNode20.r , tex2DNode20.g , tex2DNode20.b));
				float2 appendResult15 = (float2(break9.x , break9.w));
...
/*ASEBEGIN
Version=18800
-15;-1357;685;880;-1294.926;1188.631;1.575262;True;False
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;109;2526.407,-583.296;Float;False;True;-1;2;ASEMaterialInspector;0;15;mrvc/Bloom;958921d600d7d45bf8d5d0d9cb5b541d;True;SubShader 0 Pass 0;0;0;SubShader 0 Pass 0;1;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;True;2;False;-1;True;7;False;-1;False;True;0;False;0;True;3;1;False;-1;10;False;-1;0;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;0;;0;0;Standard;0;0;4;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=93186EB4CA1A3843161575B091AB7A3134DEAA45