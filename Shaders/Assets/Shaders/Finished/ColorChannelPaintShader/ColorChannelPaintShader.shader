	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				half4 appendResult26 = (half4((( ( ( ( ( tex2DNode93.r - ( tex2DNode93.r * tex2DNode93.g ) ) - ( tex2DNode93.r * tex2DNode93.b ) ) * _RColor ) + ( ( ( tex2DNode95.g - ( tex2DNode95.r * tex2DNode95.g ) ) - ( tex2DNode95.g * tex2DNode95.b ) ) * _GColor ) + ( ( ( tex2DNode101.b - ( tex2DNode101.r * tex2DNode101.b ) ) - ( tex2DNode101.g * tex2DNode101.b ) ) * _BColor ) ) + ( ( tex2DNode106.r * tex2DNode106.g ) * _RGColor ) + ( ( tex2DNode107.r * tex2DNode107.b ) * _RBColor ) + ( ( tex2DNode108.g * tex2DNode108.b ) * _GBColor ) )).rgb , tex2D( _MainTex, uv_MainTex ).a));
...
/*ASEBEGIN
Version=18800
195;-1344;2096;1124;1823.715;-581.0538;1.354665;True;True
...
Node;AmplifyShaderEditor.SamplerNode;3;101.3739,1134.928;Inherit;True;Property;_TextureSample0;Texture Sample 0;5;0;Create;True;0;0;0;False;0;False;-1;9a2f2a5aa824e465ebc74441a66801e8;9bddeece3df2e410ab366b121cffefd1;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=564A3B069AA9CBA62EE8B3142A9606F768765D16